...
from tarviz.utils import bQTLs_data, http_ensembl_binding_matrix, bqtls_hit_counts, \
    load_data, feature_columns, look_up_variant_gtex, open_targets_df, phewas, look_up_variant_gtex_tissue, open_targets_v2g
...
bqtls= list(set(data[data[mt_method]<=pvalue]["BQTL"].dropna()))
